namespace FileProcessor.BusinessLogic.Requests
{
    ...
    /// <seealso cref="System.IEquatable{FileProcessor.BusinessLogic.Requests.VoucherRequest}" />
    public record VoucherRequest : IRequest
    {
        #region Constructors
        ...
        public VoucherRequest(Guid fileId,
                              String fileName,
                              Guid fileProfileId)
        {
            this.FileId = fileId;
