...
namespace FileProcessor.IntegrationTests.Features
{
    ...
    //    public void GivenIHaveAVoucherTopupFileWithTheFollowingContents(Table table)
    //    {
    ...
    //        String filepath = $"/home/runner/specflow/vouchertopup_{fileNameId.ToString("N")}.txt";
